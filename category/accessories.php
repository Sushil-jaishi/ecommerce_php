            ...
            <div class="col-md-2 mb-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <a href="accessories.php?id=<?php echo $product[$i]['id']; ?>" class="card-link text-decoration-none border text-white" style="background-color: rgb(221, 117, 242);">Add to cart</a>
                        <a href="buy.php?<?php echo $product[$i]['id']; ?>" class="card-link text-decoration-none border text-white" style="background-color: rgb(221, 117, 242);">Shop Now</a>
                    </div>
                </div>
            </div>
            <?php
