        ...
        <div class="col-md-6">
            ...
            <form id="addProductForm">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="productDescription" rows="3" placeholder="Enter a short description" required></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="productCategory" required>
                        <option value="Home" disabled selected>Home</option>
